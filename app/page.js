...
export default function HomePage() {
  ...
  const htmlContent = `
    ...
    <div class="floating-icons">
        <div class="float-icon" style="left: 10%; top: 20%; animation-delay: 0s;">🏃</div>
        <div class="float-icon" style="left: 85%; top: 15%; animation-delay: 2s;">🥗</div>
        <div class="float-icon" style="left: 15%; top: 70%; animation-delay: 4s;">🏋️</div>
        <div class="float-icon" style="left: 80%; top: 65%; animation-delay: 3s;">🍎</div>
        <div class="float-icon" style="left: 50%; top: 10%; animation-delay: 1s;">⚡</div>
        <div class="float-icon" style="left: 20%; top: 85%; animation-delay: 5s;">🥑</div>
    </div>
            ...
            <div class="card-auth">
                ...
                <div id="loginForm" class="form-container">
                    ...
                    <div class="google-signin-section">
                        <div id="g_id_onload"
                             data-client_id="329300608269-tpv1dff78acj6j0avi07872u0kvgkhn1.apps.googleusercontent.com"
                             data-context="signin"
                             data-ux_mode="popup"
                    ...
                    <button class="btn-primary" onclick="handleSupabaseLogin()">Masuk</button>
                ...
                <!-- ========================================
                    ...
                    ✅ FIXED VERSION - Proper Scrollable Container
                    Copy-paste bagian ini untuk replace register form Anda
                    ======================================== -->

                <form id="registerForm" class="register-form-wrapper" style="display: none;" onsubmit="handleSupabaseRegister(event); return false;">
                    ...
                    <div class="google-signin-section">
                        <button type="button" class="btn-google" onclick="initGoogleSignUp()">
                    ...
                    <!-- ⭐ Progress Indicator (Fixed - Outside scrollable area) -->
                    <div id="regProgressSteps" class="progress-steps">
                    ...
                    <!-- ⭐⭐⭐ CRITICAL FIX: Scrollable Container Wrapper ⭐⭐⭐ -->
                    <div class="form-container" style="max-height: 65vh; overflow-y: auto; overflow-x: hidden; scroll-behavior: smooth; padding-right: 10px; margin-bottom: 1.5rem;">
                        
                        <!-- SECTION 1: AKUN -->
                        <div id="regSection1" class="form-section">
                        ...
                        <div id="regSection2" class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio-group">
                                    <div class="radio-option">
                                        <input type="radio" name="jenisKelamin" value="Laki-laki" id="regGenderMale" required>
                                        <label for="regGenderMale" class="radio-label">
                                            <span class="radio-icon">👨</span>
                                            Laki-laki
                                        </label>
                                    </div>
                                    <div class="radio-option">
                                        <input type="radio" name="jenisKelamin" value="Perempuan" id="regGenderFemale">
                                        <label for="regGenderFemale" class="radio-label">
                                            <span class="radio-icon">👩</span>
                                            Perempuan
                                        </label>
                                    </div>
                        ...
                        <div id="regSection3" class="form-section">
                            <h3 class="section-title">📏 Data Fisik</h3>
                        ...
                        <div id="regSection4" class="form-section goal-section">
                            <h3 class="section-title">🎯 Target Berat Badan Anda</h3>
        ...
        <div class="container">
            <div class="card-auth" style="max-width: 700px;">
                <div class="header-section">
                    ...
                    <h2>Selamat Datang, <span id="googleUserName"></span>! 👋</h2>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" 
                                       ...
                                       title="Format: 08123456789 atau +628123456789 (hanya angka)"
                                       inputmode="numeric"
                                       required>
                            </div>
                        </div>
                        
                        <!-- Password Fields for Google Sign-In -->
                        <div class="form-row">
                            <div class="form-group">
                                <label>Password <span class="required">*</span></label>
                                <input type="password" id="googlePassword" placeholder="Minimal 6 karakter" required minlength="6">
                                <small style="color: #6b7280; font-size: 0.85rem;">Minimal 6 karakter</small>
                            </div>
                            
                            <div class="form-group">
                                <label>Konfirmasi Password <span class="required">*</span></label>
                                <input type="password" id="googlePasswordConfirm" placeholder="Ketik ulang password" required minlength="6">
                                <small style="color: #6b7280; font-size: 0.85rem;">Harus sama dengan password</small>
                            </div>
                        </div>
                    </div>
    ...
    <div id="dashboardPage" class="page">
        ...
        <nav class="navbar">
            <div class="nav-container">
                ...
                <div class="nav-links">
                    <a href="#" id="nav-dashboard" class="nav-link active" onclick="showDashboard()">🏠 Dashboard</a>
                    <a href="#" id="nav-analytics" class="nav-link" onclick="showAnalytics()">📊 Analytics</a>
                    <a href="#" id="nav-harian" class="nav-link" onclick="showHarian()">📝 Input Harian</a>
                </div>
                <div class="nav-actions">
                    ...
                    <button class="btn-logout" onclick="handleSupabaseLogout()">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <nav class="mobile-nav-menu">
            ...
            <a href="#" class="nav-link" onclick="showHarian(); closeMobileMenu();">
                <span class="nav-icon">📝</span> Input Harian
            </a>
            ...
            <div class="mobile-user-section">
                ...
                <button class="mobile-logout-btn" onclick="handleSupabaseLogout()">
                ...
                <div class="weight-tracker-section">
                    <div class="weight-tracker-card">
                        ...
                        <div class="weight-chart-mini">
                            <h4>📈 Progress 7 Hari Terakhir</h4>
                        ...
                        <div class="weight-history-preview">
                            <div class="history-header">
                                ...
                                <button class="btn-text" onclick="openWeightHistoryModal()">Lihat Semua →</button>
                            </div>
        ...
        <div id="analyticsContent" class="content">
            <div class="analytics-container">
                ...
                <div class="analytics-card">
                    ...
                    <button class="btn-primary" onclick="generateAnalyticsInsight()">🧠 Generate AI Insight</button>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content modal-large">
                ...
                <div class="modal-body">
                    ...
                    <div class="ai-analysis">
                        <h4>🤖 Analisis AI - Aktivitas Langkah Kaki</h4>
        ...
        <div id="runningModal" class="modal">
            <div class="modal-content modal-large">
                ...
                <div class="modal-body">
                    ...
                    <div class="ai-analysis">
                        <h4>🤖 Analisis AI - Performa Lari</h4>
        ...
        <div id="waterModal" class="modal">
            <div class="modal-content modal-large">
                ...
                <div class="modal-body">
                    ...
                    <div class="ai-analysis">
                        <h4>🤖 Rekomendasi AI untuk Hidrasi</h4>
                ...
                <div class="modal-body">
                    <div class="input-section">
                        ...
                        <select id="exerciseCategorySelect" onchange="updateExerciseTypes()">
                            ...
                            <option value="cardio">🏃 Cardio & Aerobik</option>
                            ...
                            <option value="sports">⚽ Sports & Martial Arts</option>
                            <option value="aquatic">🏊 Aquatic Exercise</option>
                    ...
                    <div class="ai-analysis">
                        <h4>🤖 Analisis AI - Program Latihan</h4>
        ...
        <div id="sleepModal" class="modal">
            <div class="modal-content modal-large">
                ...
                <div class="modal-body">
                    ...
                    <div class="ai-analysis">
                        <h4>🤖 Analisis Kualitas Tidur dari AI</h4>
            ...
            <div class="modal-content modal-large">
                ...
                <div class="modal-body">
                    <div class="input-section">
                        ...
                        <button class="btn-camera" onclick="detectFoodFromPhoto()">📸 Deteksi dari Foto</button>
                        <button class="btn-add" onclick="addFood()">Tambah Makanan</button>
                    </div>
                    
                    <div class="ai-analysis">
                        <h4>🤖 Analisis Nutrisi AI</h4>
    ...
    <div id="weightHistoryModal" class="modal">
        <div class="modal-content modal-extra-wide">
            ...
            <div class="modal-header">
                <h3>📊 Riwayat Berat Badan Lengkap</h3>
...
{/* Load all scripts ONCE via Next.js Script component */}
<Script src="/supabase-integration.js" strategy="afterInteractive" />
<Script src="/registration-handler.js" strategy="afterInteractive" />
<Script src="/weight-tracker-integrated.js" strategy="afterInteractive" />
<Script src="/weight-tracker-expose.js" strategy="afterInteractive" />
<Script src="/supabase-activity-sync.js" strategy="afterInteractive" />
<Script src="/complete-profile-auto-highlight.js" strategy="afterInteractive" />

{/* ❌ REMOVED: Replaced by enhanced version */}
{/* <Script src="/register-progress-highlight.js" strategy="afterInteractive" /> */}

{/* ⭐ Enhanced Registration Progress System */}
<Script src="/registration-progress-enhanced.js" strategy="afterInteractive" />
